...
\subsection{Use Case: Starting up FreeBSD, interacting with the shell, and then shutting down the system.}
...
\begin{figure}[!htb]
	...
	\includesvg[inkscapelatex=false, width = 570pt]{sequence_diagrams/system-flow}
