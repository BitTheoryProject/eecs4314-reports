...
\begin{thebibliography}{00}
	...
	\bibitem{sockets} "Chapter 7. Sockets." FreeBSD Documentation Portal, https://docs.freebsd.org/en/books/developers-handbook/sockets/.
	\bibitem{zfs} "Chapter 21. the Z File System." FreeBSD Documentation Portal, https://docs.freebsd.org/en/books/handbook/zfs/.
	\bibitem{brk} "FreeBSD Manual Pages." Brk, https://man.freebsd.org/cgi/man.cgi?query=brk.
	\bibitem{malloc} "FreeBSD Manual Pages." Malloc, https://man.freebsd.org/cgi/man.cgi?query=malloc.
	\bibitem{kobj} "Chapter 3. Kernel Objects." FreeBSD Documentation Portal, https://docs.freebsd.org/en/books/arch-handbook/smp/.
	...
	\bibitem{mallocfree} “Malloc and Free.” Malloc, Section 3., 1997, https://docs.freebsd.org/44doc/papers/malloc-3.html.
